...
void GamePadController::ProcessGameController(Camera* camera)
{
	...
	//camera->SetForawrdBack(static_cast<float>(thumbLY) / 1000);
	//camera->SetLeftRight(static_cast<float>(thumbLX) / 1000);
	Framework::This()->GetCamera()->SetForawrdBack(static_cast<float>(thumbLY) / 3000);
	Framework::This()->GetCamera()->SetLeftRight(static_cast<float>(thumbLX) / 3000);
	...
	//camera->SetPitch(static_cast<float>(-thumbRY) / 5000000000);
	//camera->SetYaw(static_cast<float>(thumbRX) / 5000000000);
	Framework::This()->GetCamera()->SetPitch(static_cast<float>(-thumbRY) / 5000000000);
	Framework::This()->GetCamera()->SetYaw(static_cast<float>(thumbRX) / 5000000000);
